...
<body>
    ...
    <h1>Differenza importazione per abitante</h1>
    ...
    <table>
        ...
        $sql = "SELECT n.nomeNazione AS NomeNazione, p.nomeProdotto AS NomeProdotto,
        (SUM(c.quantitaConsumata) / n.numAbitanti) - (SUM(pr.quantitaProdotta) / n.numAbitanti) AS Differenza
        FROM nazioni n, prodotti p, produzioni pr, consumazioni c
        WHERE n.codNazione = pr.codNazione AND p.codProdotto = pr.codProdotto AND n.codNazione = c.codNazione AND p.codProdotto = c.codProdotto
