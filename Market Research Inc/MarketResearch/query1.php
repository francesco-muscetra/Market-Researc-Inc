...
<body>
    ...
    <h1>Quantità consumata per abitante</h1>
    ...
    <table>
        ...
        $sql = "SELECT DISTINCT n.nomeNazione AS NomeNazione, p.nomeProdotto AS NomeProdotto, (c.quantitaConsumata/n.numAbitanti) AS Rapporto
        FROM nazioni n, prodotti p, consumazioni c
        WHERE n.codNazione = c.codNazione AND p.codProdotto = c.codProdotto
